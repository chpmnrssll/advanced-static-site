export default class Navigation {
  ...
  static scrollTo(destination, duration = 200, easing = 'linear') {
    const easings = {
      linear(t) {
        return t;
      },
    ...
    let scrollOffset = destinationOffset;
    if (documentHeight - destinationOffset < windowHeight) {
      scrollOffset = documentHeight - windowHeight;
    }
    const destinationOffsetToScroll = Math.round(scrollOffset);
